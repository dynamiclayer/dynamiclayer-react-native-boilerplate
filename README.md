<p>
    <a href="https://dynamiclayers.de" >
      <img alt="Dynamic Layer - React native and Figma components" width="100%" src="https://uploads-ssl.webflow.com/625ad6a79b212f513b883f58/656e4b24bd4d97ede158e381_react-native-github-read-me.jpg">
    </a>
</p>
...
Dynamic Layer is an collection of UI components built with Figma and React native that you can use as a starting point when coding user interfaces and mobile apps.
...
Start using over 200+ free and open-source collection of solid and outline SVG icons built for React native and with support for Figma:
...
Get access to all premium features including the complete Figma design system and access to all 20+ React native components:
